...
unstable.mkShell {
  nativeBuildInputs = with unstable; [ 
    (python3.withPackages (pyPkgs: let
        twitchPython = pyPkgs.callPackage ./packages/python/twitch-python { };
        twitchChatDownloader = pyPkgs.callPackage ./packages/python/twitch-chat-downloader { inherit twitchPython; };
      in with pyPkgs; [
      pandas
      twitchPython
